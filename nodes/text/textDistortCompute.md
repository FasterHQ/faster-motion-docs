...
|-----------|------|---------|-------------|
| `stagger` | float | `0.5` | Stagger (min: 0, max: 1, step: 0.05) |
| `maxOffsetX` | float | `50` | Max Offset X (step: 5) |
| `maxOffsetY` | float | `50` | Max Offset Y (step: 5) |
| `maxRotation` | float | `0.5` | Max Rotation (rad) (step: 0.1) |
| `maxScaleDeviation` | float | `0.5` | Max Scale Deviation (step: 0.1) |
