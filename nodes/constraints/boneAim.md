...
|-----------|------|---------|-------------|
| `offsetAngle` | float | `0` | Offset Angle (step: 0.01) |
| `smoothing` | float | `0` | Smoothing (min: 0, max: 1, step: 0.01) |
| `minAngle` | float | `—` | Min Angle (step: 0.01) |
| `maxAngle` | float | `—` | Max Angle (step: 0.01) |
